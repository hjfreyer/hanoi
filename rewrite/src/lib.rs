...
//! language and [`rules`] the equations over it; [`nf`] is the case-tree
//! normal form — symbolic evaluation as a second, derivation-free judge of
//! equality; [`goal`] is a claim and what became of it; [`hant`] is the
